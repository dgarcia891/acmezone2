...
import { usePodSettings, useSavePodSettings, useValidateRemoveBgKey, useAddShop, useRemoveShop, useToggleShop, useSetShopAutoPublish, useSetShopMargin, useFetchPrintifyShops } from "@/hooks/usePodPipeline";
...
export default function PodSettingsForm() {
  ...
  const setShopMarginMutation = useSetShopMargin();
